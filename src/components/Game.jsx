...
const gameConfig = {
  ...
  // Added fixed values that were previously controlled by Leva
  speedOfMovingTile: 200,
  debugPhysics: false,
};

export function Games({ autoplay }) {
  ...
  // Use values from gameConfig instead of Leva controls
  const speedOfMovingTile = gameConfig.speedOfMovingTile;
  const debugPhysics = gameConfig.debugPhysics;
  ...
  const movingTileMeshRef = useRef(null);
  ...
  function spawnEffect(position, size) {
    ...
    <div style={{ height: '100vh' }}>
      ...
      >
        ...
        <Physics
          gravity={[
            0,
            -gameConfig.physics.gravityDown,
            0,
          ]}
